...
<div class="right_col" role="main">
                        ...
                        <form id="createorder-form" action="updateCategory.php?id=<?php echo $cat_id?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-6 col-xs-12">
                                    <input type="text" name="category-name" value="<?php echo $result['name']?>" required class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-6 col-xs-12">
                                <input type="checkbox" name="status" <?php if($result['status']=='active'){echo 'checked';}?> class="js-switch" id="commercial" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-8">
                                    <img src="images/category/<?php echo $result['image']?>?<?php echo time(); ?>" class="img-responsive" id="imagepreview" style="height:180px; width:180px; float:left; border: 1px solid #95a5a6 ;padding: 2px; margin-top:10px;" alt="">
    ...
    if(isset($_POST['create-button'])){
        ...
        $query = "UPDATE category SET `name`=:name,`image`=:imagename,domestic=:domestic,industrial=:industrial,commercial=:commercial,`status`=:status
                  WHERE id=:id";
