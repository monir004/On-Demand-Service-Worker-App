                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>UPDATE INFORMATION: <span class="text-capitalize"><em><?php echo $admin_details->username;?></em></span></h2>
                                    ...
                                    <form id="createorder-form" action="edit-profile.php" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5 col-sm-6 col-xs-12">
                                                <input type="text" name="first-name" value="<?php echo $admin_details->name;?>" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-sm-4 col-xs-8">
                                                <img src="images/user/<?php echo $admin_details->image;?>?<?php echo time(); ?>" class="img-responsive" id="imagepreview" style="height:180px; width:180px; float:left; border: 1px solid #95a5a6 ;padding: 2px; margin-top:10px;" alt="">
