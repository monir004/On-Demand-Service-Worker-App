                                ...
                                <div class="x_content">
                                    ...
                                    <?php
                                        if (isset($_POST['addServiceEntry'])) {
                                            ...
                                            $sqlservices = "INSERT INTO services( srvCategory, srvSubCategory, srvice, srvDetails, srvPrice, srvStatus, created, srvImage,vendor,vendor_mobile ) VALUES ('$serviceCategory','$serviceSubcategory',  '$serviceName',  '$serviceDetails', '$servicePrice', '$serviceStatus', '$serviceCreated','".$_FILES['serviceImage']['name']."','$vendor_name','$vendor_contact')";
