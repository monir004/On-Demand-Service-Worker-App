...
class DhakaAdmin {
    ...
    public function admin_login($username, $password) {
        $userchk = "SELECT * FROM admin WHERE user_name = '$username' AND admin_pass = '$password'";
    ...
    public function admin_info($adminname) {
        $admincheck = "SELECT * FROM admin WHERE user_name = '$adminname' ";
