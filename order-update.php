                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 col-sm-6 col-xs-12">
                                                    ...
                                                    if (isset($_POST['btn_accept'])) {
                                                        ...
                                                        $delvDate = date('Y-m-d');
                                                        $servStatus = "Declined";
                                                        $sqlOrdStatUpdate = "UPDATE `order_details` SET `srv_del_date`='$delvDate', `srv_state`='$servStatus', `srv_total`=0, `srv_discount`=0, `srv_amt_paid`=0, `srv_pymt_stat`='N/A'  WHERE `order_id` = '$orderID' AND `sl`= '$serviceID' LIMIT 1";;
                                                            $runOrdStatUpdateQuery = $dbcon->prepare($sqlOrdStatUpdate);
                                                            $runOrdStatUpdateQuery->execute();
                                                        // echo $sqlOrdStatUpdate;
                                                            echo '<script language="javascript">';
