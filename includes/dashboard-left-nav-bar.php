                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="images/user/<?php echo $admin_info['image'];?>?nocache=<?php echo time(); ?>" alt="..." class="img-circle profile_img">
                        </div>
                        <div class="profile_info">
                            <span>Welcome,</span>
                            <h2><?php echo $admin_info['name'];?></h2>
                        </div>
                    </div>
                    <!-- /menu profile quick info -->
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a><i class="fa fa-paper-plane-o"></i>Trending <span class="fa fa-chevron-down"></span></a>

                                    <ul class="nav child_menu">
                                        <li><a href="createtrend.php">Add New Trending</a></li>
                                        <li><a href="ViewTrend.php">View All Trendings</a></li>
                                    </ul>
                                </li>
				                <li>
