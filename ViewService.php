                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div  id="allServices" class="x_content">
                                    <div class="input-group has-feedback col-sm-3 col-sm-offset-9">
                                        ...
                                        <span class="glyphicon glyphicon-search form-control-feedback" aria-hidden="true"></span></input>
                                        <span class="input-group-btn"><button class="btn btn-default" type="button" onClick="window.location.reload();" style="color: #93A2B2;">Clear!</button></span>
                                    </div>
                                    <br />
                                    <br />
                                        ...
                                        <?php 
                                            ...
                                            foreach ($allServicesDeails as $i => $values) {
                                                $id = $values['srv_sl'];
                                                  ...
                                                  $srvPrice = ($values['srvPrice']==-1.00) ? 'Price on inspection' : $values['srvPrice'];
                                                  echo "<td>" . $srvPrice . "</td>";
