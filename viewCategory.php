                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-hover">
                            ...
                            foreach ($query as $i => $values) {
                                ...
                                echo "<td style=\"text-align:center\"><img style='width: 70px;height: 70px' src='images/category/".$values['image']."' alt=''></td>";
                                ...
                                echo "<td style=\"text-align:center;vertical-align: middle; \">" . $values['status'] . "</td>";
